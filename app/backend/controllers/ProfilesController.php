...
use PSMAS\Common\Forms\ProfilesForm;
use PSMAS\Common\Models\Profiles;

/**
 * PSMAS\Backend\Controllers\ProfilesController
...
class ProfilesController extends ControllerBase {
    ...
    public function searchAction()
    {
        ...
        if ($this->request->isPost()) {
            $query = Criteria::fromInput($this->di, 'PSMAS\Common\Models\Profiles', $this->request->getPost());
